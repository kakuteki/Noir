...
- Navigation: navbar, sidebar, tabs, breadcrumb, pagination, dropdown
- Table component with striped, bordered, compact variants
- Toast/notification component
- Spinner/loader component (spin, dots, bar)
